...
class Account:
    ...
    def deposit(self, amount):
        ...
        transaction = Transaction(self.count, self.balance - amount, self.balance)
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            transaction = Transaction(self.count, self.balance, self.balance)
            self.count = self.count + 1
            self.transactions.append(transaction)
...
class Client:
    ...
    def __init__(self, server, name):
        ...
        self.server = server
        self.name = name
        server.register_client(name, self)
    ...
    def change(self, coin):
        ...
        if res == None:
            ...
            for i in res:
                ...
                if self.coins[i] == 0:
                    del self.coins[i]
            self.coins[coin] = self.coins[coin] + 1 if coin in self.coins else 1
            return res
